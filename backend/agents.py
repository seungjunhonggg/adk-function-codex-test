...
edit_intent_agent = _build_agent(
    ...
    instructions=(
        ...
        "intent values: update_params (temperature/voltage/size/capacity/production_mode/model_name), "
        ...
        "model_name=기종/모델/제품명/타입/품번/part/chip_prod_id; "
        "production_mode=양산/생산/MP/mass=mass, 개발/샘플/시제/proto/dev=dev; "
        ...
        "model_name=기종/모델/제품명/품번/part number/chip_prod_id; "
        "production_mode=양산/개발/시제/샘플/MP/mass=mass, proto/dev=dev; "
